...
class TestOwenProtocol(unittest.TestCase):
    ...
    def test_unpack_value(self):
        ...
        self.assertEqual(0, self.trm.unpack_value("DOT0", bytearray([0]), None))
        self.assertEqual(99, self.trm.unpack_value("DOT0", bytearray([153]), None))
        self.assertEqual(304, self.trm.unpack_value("DOT0", bytearray([3, 4]), None))
        self.assertEqual(987654321, self.trm.unpack_value("DOT0", bytearray([9, 135, 101, 67, 33]), None))

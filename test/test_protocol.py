...
class TestOwenProtocol(unittest.TestCase):
    ...
    def test_unpack_value(self):
        ...
        self.assertEqual(-12, self.trm.unpack_value("I8", bytearray([244])))
        self.assertEqual(b"\xd2\xd0\xcc202", self.trm.unpack_value("STR", bytearray([50, 48, 50, 204, 208, 210])))
        self.assertIsNone(self.trm.unpack_value("U8", None))               # if empty buffer
